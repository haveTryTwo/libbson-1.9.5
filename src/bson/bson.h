 ...
 */
BSON_EXPORT(bson_t *)
bson_new_from_buffer(uint8_t **buf, size_t *buf_len, bson_realloc_func realloc_func,
 ...
 */
BSON_EXPORT(bool)
bson_append_binary(bson_t *bson, const char *key, int key_length, bson_subtype_t subtype,
 ...
 */
BSON_EXPORT(bool)
bson_append_code_with_scope(bson_t *bson, const char *key, int key_length, const char *javascript,
                            const bson_t *scope);
 ...
 */
BSON_EXPORT(bool)
bson_append_dbpointer(bson_t *bson, const char *key, int key_length, const char *collection,
 ...
 */
BSON_EXPORT(bool)
bson_append_decimal128(bson_t *bson, const char *key, int key_length,
 ...
 */
BSON_EXPORT(bool)
bson_append_regex(bson_t *bson, const char *key, int key_length, const char *regex,
                  const char *options);
 ...
 */
BSON_EXPORT(bool)
bson_append_timestamp(bson_t *bson, const char *key, int key_length, uint32_t timestamp,
                      uint32_t increment);
